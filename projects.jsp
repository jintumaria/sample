								...
								<div class="panel panel-white">
									...
									<div class="panel-body">
										<div id="rootwizard">
											...
											<% if(rs_project.getString("projectCode")!=null&&rs_project.getString("projectCode").length()>0) { %> (<%=rs_project.getString("projectCode")%> )<%  } %> <br>
																		...
																		<td>
																		<a href="projects.jsp?status=edit&id=<%=rs_project.getString("id")%>" title="View"><i class="fa fa-eye"></i></a>&nbsp;&nbsp;
