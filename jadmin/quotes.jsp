  ...
  <script type="text/javascript" src="ckeditor/ckeditor.js"></script>
   <script type="text/javascript" src="ckfinder/ckfinder.js"></script>	
    ...
    <div class="tab-pane active fade in" id="tab1">
       ...
       <form id="wizardForm" name="wizardForm" method="post" action="quote-submit.jsp">
        		...
        		<div class="col-md-12">
        			<div class="row">
        				<div class="form-group col-md-2">
                         <label for="exampleInputName2">Quote No</label>
                         <%if(status.equals("edit")){%>
                         <input type="text" class="form-control" required name="quoteNo" readonly   placeholder="Quote Number" value="<%=showQuoteNo%>"  maxlength="249"  >
                         <%}else{%>
                         <input type="text" class="form-control" required name="quoteNo"   placeholder="Quote Number" value="<%=showQuoteNo%>"  maxlength="249"  >
                         <%}%>
                        </div>
        		...
        		<div class="col-md-12">
        			<div class="row">
        				<div class="form-group col-md-5">
                                ...
                                %>
                                <select name="clientName"  required id="client_name" onChange="checkAvailabilityFunction1('checkDiv',document.wizardForm.client_name.value)" class="js-states form-control" tabindex="-1" style="width: 100%">
                                <%
								if(status.equals("edit"))
								{
								%>
        		...
        		<div class="col-md-12">
        			<div class="row">
                        ...
                        <div class="form-group col-md-1"><br>
                         <button type="button" onClick="checkAvailabilityFunction5('checkDiv1',document.wizardForm1.item_name.value,document.wizardForm1.item_qty.value,document.wizardForm1.item_rate.value,document.wizardForm.quoteNo.value);" class="btn btn-secondary">Add</button>
                        </div>
                    </div>
                </div>
        </div>
        			...
        			<div class="table-responsive">     
						...
						int j=0;
						 double value_amount=0.00,tot_value_amount=0.00;
			  			...
			  			query_invoice_temp="select * from add_cart where userId='"+session.getAttribute("admin_id")+"' and sessionId='"+showQuoteNo+"' and status='A' order by modifiedDateTime desc";
