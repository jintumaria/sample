             ...
             <div class="col-md-12">
              ...
              <div class="col-md-12">
               <div class="panel panel-white">
                   ...
                   <div class="panel-body">
                     <div align="right">
                     <a href="invoices.jsp" ><button type="button" class="btn btn-secondary"><i class="fa fa-truck m-r-xs"></i>&nbsp;&nbsp;Add Invoices</button></a>
                     </div>
                   		<br><br>
                       ...
                       <table  id="example" class="display table" style="width: 100%; cellspacing: 0;">
                        ...
                        <tbody>
                                        <%
						int i=0;
						String query="select ino,clientName,dueDate,id,invoiceStatus from invoice_tab where userId='"+session.getAttribute("admin_id")+"' order by modifiedDateTime desc";
...
%>
            ...
            %>                           
                                            <tr>
                                                <td><%=i%></td>
                                                <td><a href="invoice.jsp?invoice_no=<%=rs_invoice.getString("ino")%>"><%=rs_invoice.getString("ino")%></a></td>
                                                <td><%=rs_invoice.getString("clientName")%></td>
                                                <td><%=rs_invoice.getString("dueDate")%></td>
												...
												if(rs_invoice.getString("invoiceStatus").equals("ENABLED"))
												{
												%>               
                                            <a href="invoices.jsp?status=edit&id=<%=rs_invoice.getString("id")%>" title="Edit"><i class="fa fa-edit"></i></a>&nbsp;&nbsp;<a href="invoices-submit.jsp?status=delete&id=<%=rs_invoice.getString("ino")%>" onClick="return con_delete()" title="Trash"><i class="fa fa-trash"></i></a>
                                            <%}
                                            if(tot_calculate_3<=0&&!(rs_invoice.getString("invoiceStatus").equals("ENABLED")))
                                            {
                                            	%>               
                                              <a href="invoices.jsp?type=copy&id=<%=rs_invoice.getString("ino")%>" title="Copy"><i class="fa fa-copy"></i></a>
                                                <%
                                            }
                                            %>
                                            </td>
