                     ...
                     <a href="invoices.jsp" ><button type="button" class="btn btn-secondary"><i class="fa fa-truck m-r-xs"></i>&nbsp;&nbsp;Add Invoices</button></a>
                       ...
                       <table  id="example" class="display table" style="width: 100%; cellspacing: 0;">
                        ...
                        <tbody>
                                        <%
						int i=0;
						String query="select ino,client_name,due_date,id,invoice_status from invoice_tab where user_id='"+session.getAttribute("admin_id")+"' order by modified_date desc";
...
%>
            <%@include file="payments.jsp"%>                            
                                            <tr>
												...
												if(rs_invoice.getString("invoice_status").equals("ENABLED"))
												{
												%>               
                                            ...
                                            <%}
                                            if(tot_calculate_3<=0&&!(rs_invoice.getString("invoice_status").equals("ENABLED")))
                                            {
                                            	%>               
