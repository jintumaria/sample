					...
					if(request.getParameter("msg").equals("2"))		{%>		 <div class="alert alert-success alert-dismissible" role="alert">
						...
						int j=0;
						 double value_amount=0.00,tot_value_amount=0.00;
			  			String query_invoice_temp="select * from add_cart where user_id='"+session.getAttribute("admin_id")+"' and session_id='"+request.getParameter("id")+"' and status='B' order by modified_date desc";
...
%>
                                            ...
                                            <tr>
                                                ...
                                                <td><a href="record-payment-submit.jsp?status=delete&id=<%=rs_invoice_temp.getString("session_id")%>&idq=<%=rs_invoice_temp.getString("id")%>" onClick="return con_delete()" title="Trash"><i class="fa fa-trash"></i></a></td>
                                            </tr>
