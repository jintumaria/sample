...
<%
String titleName="",titleAuthor="",recordInvoice="";
...
ResultSet rsCheckStatus=stCheckStatus.executeQuery("select status from check_tab where employeeId='"+session.getAttribute("login_id")+"'  order by id asc"); // and date='"+strDate+"'
