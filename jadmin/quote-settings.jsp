				...
				if(request.getParameter("msg").equals("1"))		{%>		 <div class="alert alert-success alert-dismissible" role="alert">
                    ...
                    <div class="tab-content">
                     ...
                     <table id="example" class="display table" style="width: 100%; cellspacing: 0;">
						...
						int i=0;
			  			int flag_count=0;
						String query="select * from tax_tab where user_id='"+session.getAttribute("admin_id")+"' order by modified_date desc";
...
<form id="wizardForm2" name="wizardForm2" method="post" action="tax-settings-submit.jsp">
                                            ...
                                            <tr>
                                                <td><%=i%></td>
                                                <td> <input type="text" class="form-control" style="width:200px;" name="tax_name" value="<%=rs_tax.getString("tax_name")%>"  maxlength="19" placeholder="Tax Name" ></td>
                                                <td><input type="text" class="form-control" style="width:200px;" name="tax_percent" value="<%=rs_tax.getString("tax_percent")%>"  maxlength="19" placeholder="Tax Name" ></td>
                                                <td><%												
