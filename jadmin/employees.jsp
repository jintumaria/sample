            ...
            <div class="page-inner">
                <div class="page-breadcrumb">
                    <ol class="breadcrumb container">
                        ...
                        <li class="active"><%=nameText%> Employee</li>
                    </ol>
                </div>
                <div class="page-title">
                    <div class="container">
                        <h3><%=nameText%> Employee</h3>
                    </div>
                </div>
                <div id="main-wrapper" class="container">
				 <div class="panel-body">
                     <a href="employees-search.jsp"><button type="button" class="btn btn-success btn-addon m-b-sm btn-rounded"><i class="fa fa-search"></i> Search Employees</button></a>                                        
                    </div>
                    <div class="row">
                            ...
                            <div class="panel panel-white">
                                <div class="panel-body">
                                    <div id="rootwizard">
                                        ...
                                        <form id="wizardForm" name="wizardForm" method="post" action="employees-submit.jsp">
                                                        ...
                                                        <div class="col-md-6">
                                                            <div class="row">
                                                                ...
                                                                <div class="form-group col-md-6">
                                                                    ...
                                                                    <input type="password"  maxlength="99" required class="form-control" name="password" id="password" value="<%=password%>"  placeholder="Password" >
                                                                </div>
																<div class="form-group col-md-6">
                                                                    <label for="ConfirmPassword">Confirm Password</label>
                                                                    <input type="password"  maxlength="99" required class="form-control" name="confirmpassword" value="<%=password%>"  id="confirmpassword" placeholder="Confirm Password">
                                                                </div>
