                ...
                <div id="main-wrapper" class="container">
                   ...
                   <div class="col-md-12">
                       ...
                       <div id="rootwizard">
                   		...
                   		<form  enctype="multipart/form-data" method="post" action="upload-images-submit.jsp">
							...
							<div class="form-group col-md-12">
                              ...
                              <div class="form-group col-md-6">  
                               <div class="profile-image-container">
                               		<img src="documents/<%=employeeId %>.jpg" onerror="this.src='documents/avatar.png'"  alt="" width="100" height="130">
                            	</div>
							...
							<div class="form-group col-md-12">
                              ...
                              <div class="form-group col-md-6">  
                               <div class="profile-cover" style="width: 400px;height: 125px;">
                            			<img src="documents/<%=employeeId %>_COVER.jpg" onerror="this.src='documents/profile-cover.png'" alt=""  width="400" height="125">
